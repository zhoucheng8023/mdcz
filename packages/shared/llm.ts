...
export const LLM_REASONING_EFFORT_OPTIONS = ["low", "medium", "high", "max"] as const;
...
export const LLM_REASONING_OPTIONS = ["default", "disabled", "enabled", ...LLM_REASONING_EFFORT_OPTIONS] as const;
